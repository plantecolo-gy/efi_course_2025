...
A typical post-fire recovery curve is a negative exponential, where the vegetation greenness (NDVI) increases rapidly after fire, but then slows down as it approaches a maximum value.
