...
![](images/joint_marginal_continuous.png){.absolute right=-50 top=100 height=500 width=500}
...
![](images/joint_continuous.png){.absolute right=-50 top=150 height=500 width=500}
...
![](images/sharksquito_full.png){.absolute top=80 right=-90 height="80%"} 
...
![](images/normal_small_sample.png){.absolute left=50 top=220 height=300 width=300}

. . .


![](images/normal_large_sample.png){.absolute right=50 top=220 height=300 width=300}
